...
class NavHostFragment : Fragment(), NavHost {
    ...
    public override fun onInflate(
        ...
        context.obtainStyledAttributes(attrs, androidx.navigation.fragment.R.styleable.NavHostFragment).use { array ->
            val defaultHost = array.getBoolean(androidx.navigation.fragment.R.styleable.NavHostFragment_defaultNavHost, false)
            if (defaultHost) {
                defaultNavHost = true
            }
        }
